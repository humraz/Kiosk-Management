...
public class pmreportloss extends AppCompatActivity {
EditText ed;
EditText ed2;
    String loss;
    String stock;
    ...
    {
        Intent in = new Intent(this, pmlosslog.class);
        startActivity(in);
    }
    ...
    public  void reploss(View view)
    {
        ...
        if(l.equals("")|| c.equals(""))
        {
            ...
            Firebase ref2 = new Firebase("https://kioskfarm.firebaseio.com/procurementloss/");
