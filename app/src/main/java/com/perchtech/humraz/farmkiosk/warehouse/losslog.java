...
public class losslog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_losslog);
    ...
    public void read()
    {
        final Firebase ref = new Firebase("https://kioskfarm.firebaseio.com/loss-history/");
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot usersSnapshot) {
                for (DataSnapshot userSnapshot : usersSnapshot.getChildren()) {
                    ...
                    String com= user1.getComment().toString();
                    String st = "Date reported: " + stock + "\nTime Reported: " + time+ "\nReason: "+com;

                    cardslis.add("Loss of "+loss + " Units");
                    cardsdes.add(st);
