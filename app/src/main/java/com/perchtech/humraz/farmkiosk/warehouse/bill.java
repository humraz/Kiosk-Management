...
public class bill extends Activity implements OnItemSelectedListener{
String stock;
    String ratenuts;
    String kadki;
    String nuts;
    ...
    public void ca2(View view)
    {
        ...
        Intent in = new Intent( this, paybill.class);
    ...
    public void readsups() {
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot usersSnapshot) {
                ...
                for (DataSnapshot userSnapshot : usersSnapshot.getChildren()) {
                    supplier user1 = userSnapshot.getValue(supplier.class);
                ...
                ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(bill.this, android.R.layout.simple_spinner_item, sups);
                ...
                spinner.setOnItemSelectedListener(bill.this);
            }
